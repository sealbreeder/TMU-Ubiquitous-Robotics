# The 7th "Group Work (1)" (June 3)
# 第7回 「グループワーク(1)」 （6月3日）

# The 8th "Group Work (2)" (June 10)
# 第8回 「グループワーク(2)」 （6月10日）

# The 9th "Group Work (3)" (June 17)
# 第9回 「グループワーク(3)」 （6月17日）
...
- [1. English](#1-english)
  ...
  - [1.10. myAGV](#110-microbit-スターターキット)
  - [1.11. CRANE+](#111-intel-realsense)
  - [1.12. Leap Motion](#112-leap-motion)
  - [1.13. Kachaka](#113-kachaka)
- [2. 日本語](#2-日本語)
...
Below is the documentation for myAGV JN 2023.
- https://docs.elephantrobotics.com/docs/myagv-2023-en/2-serialproduct/2.13-myAGV2023/JN/1-HardwareStructure.html
...
- User name: ubuntu(For myAGV JN 2023, `er`)
- Password: Elephant
...
- ユーザー名：ubuntu(myAGV JN 2023の場合は`er`)
- パスワード：Elephant
