<img width="3840" height="1200" alt="image" src="https://github.com/user-attachments/assets/13f920ed-72b7-4f9c-89b8-c452ad8c9894" /># The 4th "Tool Installation and Checking" (May 13)
# 第4回 「開発環境の構築と動作確認」 (5月13日)
...
- [CMake](https://github.com/Kitware/CMake/releases/download/v3.31.12/cmake-3.31.12-windows-arm64.msi)
...
- [RT-Component development practice(1)](260520)
- [RT-Component development practice(2)](260527)

## 日本語
### 1. 講義スライド

- [スライド(PDF)](260513_都立大.pdf)
...
- [RTコンポーネントの開発実習(1)](260520)
- [RTコンポーネントの開発実習(2)](260527)
