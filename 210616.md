# The 8th "Group Work (3)" (June 15th)
# 第10回 「グループワーク(2)」 （6月15日）
...
- [2. Setting up JetBot](#2-setting-up-jetbot)
    ...
    - [Developing on JetBot](#developing-on-jetbot)
    - [2.4. How to connect Jetson nano](#24-how-to-connect-jetson-nano)
    - [RaspberryPi Mouse (Real Robot)](#raspberrypi-mouse-real-robot)
...
- [4. Jetbotセットアップ](#4-jetbotセットアップ)
    ...
    - [JetBot上での開発](#jetbot上での開発)
    - [4.4. Jetson nanoへの接続方法](#44-jetson-nanoへの接続方法)
    - [RaspberryPi Mouse (実機)](#raspberrypi-mouse-実機)
...
### 2.4. How to connect Jetson nano
