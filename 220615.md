...
# The 9th "Group Work (2)" (June 15th)
# 第9回 「グループワーク(2)」 （6月15日）

Continuing from the previous session, this time the participants will work in groups to practise the Service Robot Design Matrix (SRDM).
In addition, group work on robotic system development will be explained.

今回は前回から引き続き、グループに分かれて、Service Robot Design Matrix (SRDM) の実習を行います。
また、ロボットシステム開発のグループワークについて説明します。
...
Also, group work on robotic system development will be explained.
- [Group work on SRDM](SRDM_GW_220615.pdf)
...
先週のグループワークの続きを行います。
Service Robot Dsigne Matrix (SRDM) の実習を行います。
また、ロボットシステム開発のグループワークについて説明します。
- [SRDMのグループワーク続き](SRDM_GW_220615.pdf)
