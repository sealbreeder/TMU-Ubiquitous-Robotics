# The 10th "Group Work (3)" (June 22th)
...
- [4. Jetbotセットアップ](#4-jetbotセットアップ)
    ...
    - [4.8. myCobot](#48-mycobot)
    - [4.9. Kobuki](#49-kobuki)
    - [4.10. レゴ マインドストームEV3](#410-レゴ-マインドストームev3)
    - [4.11. TurtleBot3 Burger](#411-turtlebot3-burger)
    - [4.12. micro:bit スターターキット](#412-microbit-スターターキット)
...
### 2.11. TurtleBot3 Burger

### 2.12 micro:bit スターターキット
...
### 4.11. TurtleBot3 Burger

### 4.12 micro:bit スターターキット
